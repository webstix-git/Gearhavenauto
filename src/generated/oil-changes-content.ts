// Auto-generated from Gear Haven Auto & Diesel - Oil Changes.html
export const OIL_CHANGES_HTML = `<div class="gh-service-page" style="min-height:100vh;overflow-x:hidden">
  ...
  <section id="top" style="position:relative;background:#0E1720;overflow:hidden">
    ...
    <div style="position:absolute;inset:0;overflow:hidden">
      <img src="/images/oil-changes-8b2c3473.jpg" alt="Gear Haven technician servicing a vehicle" style="width:100%;height:100%;object-fit:cover;animation:gh-kenburns 22s ease-in-out infinite alternate">
    </div>
  ...
  <nav aria-label="Breadcrumb" class="gh-breadcrumb" style="background:#F6F4F0;border-bottom:1px solid #E7E4DD">
    <div style="max-width:1240px;margin:0 auto;padding:14px 28px;display:flex;align-items:center;gap:10px;font-size:14.5px;color:#5C6B76">
      ...
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#A8B2BB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg>
      <span style="color:#14202B;font-weight:600">Oil Changes</span>
    </div>
  </nav>


  <!-- WHY IT MATTERS -->
  <section class="gh-section-pad" style="max-width:1240px;margin:0 auto;padding:92px 28px">
    <div class="gh-grid-asymmetric" style="display:grid;grid-template-columns:1.05fr .95fr;gap:60px;align-items:center">
      <div data-reveal>
        <div style="display:inline-flex;align-items:center;gap:9px;font-size:13px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#3E5C76;margin-bottom:16px"><span style="width:26px;height:2px;background:#6D9DC5"></span>Why It Matters</div>
      ...
      <div data-reveal style="position:relative">
        <img src="/images/oil-changes-e3bc5573.jpg" alt="Inside the Gear Haven service bay" style="width:100%;height:460px;object-fit:cover;border-radius:18px;box-shadow:0 30px 60px -30px rgba(20,32,45,.55)">
      </div>
    </div>
  </section>
    ...
    <div style="max-width:1240px;margin:0 auto;padding:88px 28px">
      ...
      <div class="gh-grid-3" style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px">
        ...
        <div data-reveal style="background:#F6F4F0;border:1px solid #E7E3DB;border-radius:16px;padding:28px">
          <span style="display:grid;place-items:center;width:50px;height:50px;border-radius:13px;background:linear-gradient(135deg,#3E5C76,#2C4257);color:#fff;margin-bottom:18px"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12h4l2-8 4 16 2-8h6"></path></svg></span>
          <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;margin:0 0 8px;color:#14202B">Fresh oil &amp; new filter</h3>
          <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">The correct oil weight and a quality filter matched to your vehicle's specs.</p>
        </div>
        ...
        <div data-reveal style="background:#F6F4F0;border:1px solid #E7E3DB;border-radius:16px;padding:28px">
          ...
          <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;margin:0 0 8px;color:#14202B">Fluid top-off</h3>
          <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">We top off washer fluid, coolant, and other key fluids while you're here.</p>
        </div>

        <div data-reveal style="background:#F6F4F0;border:1px solid #E7E3DB;border-radius:16px;padding:28px">
          <span style="display:grid;place-items:center;width:50px;height:50px;border-radius:13px;background:linear-gradient(135deg,#3E5C76,#2C4257);color:#fff;margin-bottom:18px"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><circle cx="12" cy="12" r="3.2"></circle></svg></span>
          <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;margin:0 0 8px;color:#14202B">Tire &amp; pressure check</h3>
          <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">A quick look at tire condition and pressure so you leave rolling safely.</p>
        </div>

        <div data-reveal style="background:#F6F4F0;border:1px solid #E7E3DB;border-radius:16px;padding:28px">
          <span style="display:grid;place-items:center;width:50px;height:50px;border-radius:13px;background:linear-gradient(135deg,#3E5C76,#2C4257);color:#fff;margin-bottom:18px"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg></span>
          <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;margin:0 0 8px;color:#14202B">Free digital inspection</h3>
          <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">Photos and plain-language notes on anything worth keeping an eye on, no pressure.</p>
        </div>

        <div data-reveal style="background:#F6F4F0;border:1px solid #E7E3DB;border-radius:16px;padding:28px">
          <span style="display:grid;place-items:center;width:50px;height:50px;border-radius:13px;background:linear-gradient(135deg,#3E5C76,#2C4257);color:#fff;margin-bottom:18px"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4z"></path></svg></span>
          <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;margin:0 0 8px;color:#14202B">Service sticker &amp; reminder</h3>
          <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">We note your next recommended service interval so you never have to guess.</p>
        </div>

        <div data-reveal style="background:#F6F4F0;border:1px solid #E7E3DB;border-radius:16px;padding:28px">
          <span style="display:grid;place-items:center;width:50px;height:50px;border-radius:13px;background:linear-gradient(135deg,#3E5C76,#2C4257);color:#fff;margin-bottom:18px"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 9V5a3 3 0 0 0-6 0v4"></path><rect x="4" y="9" width="16" height="11" rx="2"></rect></svg></span>
          <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;margin:0 0 8px;color:#14202B">Proper disposal</h3>
          <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">Your old oil and filter are recycled and disposed of responsibly.</p>
        </div>
  ...
  <section class="gh-section-pad" style="max-width:1240px;margin:0 auto;padding:92px 28px">
    <div data-reveal style="max-width:620px;margin-bottom:48px">
      <div style="display:inline-flex;align-items:center;gap:9px;font-size:13px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#3E5C76;margin-bottom:16px"><span style="width:26px;height:2px;background:#6D9DC5"></span>Oil Options</div>
      <h2 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:40px;line-height:1.08;letter-spacing:-1px;margin:0 0 12px;color:#14202B">The right oil for how you drive.</h2>
      <p style="font-size:18px;line-height:1.6;color:#5C6B76;margin:0">Not sure which is right for your vehicle? We'll walk you through it, no upsell.</p>
    </div>
    <div class="gh-grid-4" style="display:grid;grid-template-columns:repeat(4,1fr);gap:20px">
      ...
      <div data-reveal style="background:#fff;border:1px solid #E7E3DB;border-top:4px solid #3E5C76;border-radius:16px;padding:30px 26px">
        <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:20px;margin:0 0 8px;color:#14202B">Conventional</h3>
        <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">A dependable, budget-friendly choice for older engines and lighter-duty driving.</p>
      </div>

      <div data-reveal style="background:#fff;border:1px solid #E7E3DB;border-top:4px solid #3E5C76;border-radius:16px;padding:30px 26px">
        <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:20px;margin:0 0 8px;color:#14202B">Synthetic Blend</h3>
        <p class="gh-card-desc" style="line-height:1.6;color:#5C6B76;margin:0">Better protection and longer intervals, a great balance for everyday drivers.</p>
      </div>

      <div data-reveal style="background:#fff;border:1px solid #E7E3DB;border-top:4px solid #3E5C76;border-radius:16px;padding:30px 26px">
        <h3 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:20px;margin:0 0 8px;color:#14202B">Full Synthetic</h3>
    ...
    <div style="max-width:1240px;margin:0 auto;padding:88px 28px;display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:start">
      <div data-reveal>
        ...
        <div style="display:flex;flex-direction:column;gap:14px">
          <div style="display:flex;align-items:center;gap:12px;font-size:16px;color:#3D4B56;font-weight:500"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6D9DC5" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5.5 12.2 9.8 16.5 18.5 7.8"/></svg>You're past your mileage or time interval</div>
          <div style="display:flex;align-items:center;gap:12px;font-size:16px;color:#3D4B56;font-weight:500"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6D9DC5" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5.5 12.2 9.8 16.5 18.5 7.8"/></svg>The oil-life or check-engine light is on</div>
          <div style="display:flex;align-items:center;gap:12px;font-size:16px;color:#3D4B56;font-weight:500"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6D9DC5" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5.5 12.2 9.8 16.5 18.5 7.8"/></svg>Oil looks dark, gritty, or low on the dipstick</div>
          <div style="display:flex;align-items:center;gap:12px;font-size:16px;color:#3D4B56;font-weight:500"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6D9DC5" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5.5 12.2 9.8 16.5 18.5 7.8"/></svg>Engine sounds louder or runs rougher than usual</div>
          <div style="display:flex;align-items:center;gap:12px;font-size:16px;color:#3D4B56;font-weight:500"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6D9DC5" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5.5 12.2 9.8 16.5 18.5 7.8"/></svg>You just can't remember the last one</div>
        </div>
      </div>
      <div data-reveal>
        <div style="display:inline-flex;align-items:center;gap:9px;font-size:13px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#3E5C76;margin-bottom:16px"><span style="width:26px;height:2px;background:#6D9DC5"></span>How It Works</div>
        <h2 style="font-family:'Bricolage Grotesque';font-weight:700;font-size:32px;line-height:1.1;letter-spacing:-.8px;margin:0 0 24px;color:#14202B">Simple, start to finish</h2>
  ...
  <section id="contact" style="background:#2C4257;color:#fff;position:relative;overflow:hidden">
    ...
    <div data-reveal style="position:relative;max-width:900px;margin:0 auto;padding:86px 28px;text-align:center">
      ...
      <div style="display:flex;gap:14px;flex-wrap:wrap;justify-content:center;align-items:center">
        ...
        <a href="/contact" style="display:inline-flex;align-items:center;gap:9px;background:rgba(255,255,255,.1);border:1.5px solid rgba(255,255,255,.35);color:#fff;font-weight:700;font-size:16.5px;padding:16px 28px;border-radius:10px" class="gh-hover-400">Request Appointment</a>
        <a href="/services#top" style="display:inline-flex;align-items:center;gap:9px;background:rgba(255,255,255,.1);border:1.5px solid rgba(255,255,255,.35);color:#fff;font-weight:700;font-size:16.5px;padding:16px 28px;border-radius:10px" class="gh-hover-400">All Services</a>
      </div>
    </div>
  </section>
    ...
    <div class="gh-footer-grid" style="max-width:1240px;margin:0 auto;padding:60px 28px 32px;display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:40px">
      ...
      <div>
        ...
        <div class="gh-footer-services" style="display:flex;flex-direction:column;gap:10px;font-size:14.5px">
          <a href="#top" class="gh-hover-401">Oil Changes</a>
          <a href="/auto-shop" class="gh-hover-402">Auto Shop</a>
          <a href="/tires" class="gh-hover-403">Tires &amp; Alignments</a>
          <a href="/fleet-vehicles" class="gh-hover-404">Fleet Services</a>
          <a href="/digital-inspection" class="gh-hover-405">Free Digital Inspection</a>
        </div>
      </div>
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:10px;font-size:14.5px">
          ...
          <a href="#contact" class="gh-hover-410">Contact</a>
        </div>
      </div>
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:14px;font-size:14.5px">
          ...
          <a href="mailto:office@gearhaven.com" style="display:flex;align-items:flex-start;gap:12px;color:#8FA0AD;text-decoration:none" class="gh-hover-411">
