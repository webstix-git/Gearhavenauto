// Auto-generated from Gearhaven Auto & Diesel - Oil Changes.html
  ...
  <section class="gh-section-pad" style="max-width:1240px;margin:0 auto;padding:92px 28px">
    <div class="gh-grid-asymmetric" style="display:grid;grid-template-columns:1.05fr .95fr;gap:60px;align-items:center">
      ...
      <div data-reveal style="position:relative">
        <img src="/images/oil-changes-e3bc5573.jpg" alt="Inside the Gearhaven service bay" style="width:100%;height:460px;object-fit:cover;border-radius:18px;box-shadow:0 30px 60px -30px rgba(20,32,45,.55)">
      </div>
    </div>
  </section>
  ...
  <section id="contact" style="background:#2C4257;color:#fff;position:relative;overflow:hidden">
    ...
    <div data-reveal style="position:relative;max-width:900px;margin:0 auto;padding:86px 28px;text-align:center">
      ...
      <div style="display:flex;gap:14px;flex-wrap:wrap;justify-content:center;align-items:center">
        ...
        <a href="/contact-us" style="display:inline-flex;align-items:center;gap:9px;background:rgba(255,255,255,.1);border:1.5px solid rgba(255,255,255,.35);color:#fff;font-weight:700;font-size:16.5px;padding:16px 28px;border-radius:10px" class="gh-hover-400">Request Appointment</a>
    ...
    <div class="gh-footer-grid" style="max-width:1240px;margin:0 auto;padding:60px 28px 32px;display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:40px">
      ...
      <div>
        ...
        <div class="gh-footer-company" style="display:flex;flex-direction:column;gap:10px;font-size:14.5px">
          <a href="/about-us" class="gh-hover-406">About Us</a>
          <a href="/about-us#team" class="gh-hover-407">Our Team</a>
          <a href="/reviews" class="gh-hover-408">Reviews</a>
          <a href="/faqs" class="gh-hover-409">FAQs</a>
          <a href="/contact-us" class="gh-hover-410">Contact Us</a>
        </div>
      </div>
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:14px;font-size:14.5px">
          ...
          <a href="mailto:collen@gearhaven.com" style="display:flex;align-items:flex-start;gap:12px;color:#8FA0AD;text-decoration:none" class="gh-hover-411">
