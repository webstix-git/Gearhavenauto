    ...
    <div class="gh-grid-asymmetric" style="display:grid;grid-template-columns:1.05fr 1fr;gap:56px;align-items:start">
      ...
      <div data-reveal>
        ...
        <div style="display:flex;flex-direction:column;gap:16px">
          <a href="tel:4173194798" style="display:flex;align-items:center;gap:16px;background:#fff;border:1px solid #E7E3DB;border-radius:14px;padding:20px 22px;box-shadow:0 2px 4px rgba(20,32,45,.04)">
          ...
          <a href="mailto:office@gearhaven.com" style="display:flex;align-items:center;gap:16px;background:#fff;border:1px solid #E7E3DB;border-radius:14px;padding:20px 22px;box-shadow:0 2px 4px rgba(20,32,45,.04)">
