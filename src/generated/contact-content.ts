// Auto-generated from Gearhaven Auto & Diesel - Contact.html
export const CONTACT_HTML = `<div style="min-height:100vh;overflow-x:hidden">
  ...
  <section id="top" style="position:relative;background:#0E1720;overflow:hidden">
    ...
    <div style="position:absolute;inset:0;overflow:hidden">
      <img src="/images/contact-e51e322a.jpg" alt="Gearhaven shop exterior" style="width:100%;height:100%;object-fit:cover;animation:gh-kenburns 22s ease-in-out infinite alternate">
    </div>
    ...
    <div class="gh-hero-inner" style="position:relative;max-width:1240px;margin:0 auto;padding:214px 28px 96px">
      <div style="max-width:720px">
        ...
        <p data-reveal style="font-size:19.5px;line-height:1.55;color:#CBD6E0;font-weight:500;margin:0;max-width:600px">Call, email, or send us a message. We'll get right back to you with honest answers, no pressure, no runaround.</p>
      </div>
    </div>
  </section>
  <!-- BREADCRUMBS -->
  ...
  <!-- CONTACT GRID -->
  <section class="gh-section-pad gh-contact-section" style="max-width:1240px;margin:0 auto;padding:80px 28px 40px">
    <div class="gh-grid-asymmetric" style="display:grid;grid-template-columns:1.05fr 1fr;gap:56px;align-items:start">

      <!-- LEFT: form -->
      <div data-reveal class="gh-contact-card" style="background:#fff;border:1px solid #E7E3DB;border-radius:20px;padding:38px 36px;box-shadow:0 20px 46px -28px rgba(20,32,45,.4)">
        ...
        <form id="gh-form" class="gh-contact-form" method="POST" action="/api/contact-submit" style="display:flex;flex-direction:column;gap:16px">
          ...
          <div class="cf-turnstile gh-turnstile" data-sitekey="0x4AAAAAAD8BRJveK5y7o7WA" data-theme="light" style="margin-top:4px"></div>
          <button type="submit" style="margin-top:4px;background:#6D9DC5;color:#fff;font-family:'Hanken Grotesk',sans-serif;font-weight:700;font-size:16.5px;border:none;padding:16px;border-radius:10px;cursor:pointer;box-shadow:none;transition:background .2s,transform .2s;width:100%" class="gh-hover-429">Send Request</button>
      ...
      <!-- RIGHT: info -->
      <div data-reveal class="gh-contact-info">
        ...
        <div class="gh-contact-info-list" style="display:flex;flex-direction:column;gap:16px">
          <a href="tel:4173194798" class="gh-contact-info-card" style="display:flex;align-items:center;gap:16px;background:#fff;border:1px solid #E7E3DB;border-radius:14px;padding:20px 22px;box-shadow:0 2px 4px rgba(20,32,45,.04)">
            ...
            <div class="gh-contact-info-text"><div style="font-size:13px;color:#8A96A1;font-weight:600;text-transform:uppercase;letter-spacing:.5px;margin-bottom:2px">Call or Text</div><div style="font-family:'Bricolage Grotesque';font-weight:700;font-size:20px;color:#14202B">417-319-4798</div></div>
          </a>

          <a href="mailto:collen@gearhaven.com" class="gh-contact-info-card" style="display:flex;align-items:center;gap:16px;background:#fff;border:1px solid #E7E3DB;border-radius:14px;padding:20px 22px;box-shadow:0 2px 4px rgba(20,32,45,.04)">
            ...
            <div class="gh-contact-info-text"><div style="font-size:13px;color:#8A96A1;font-weight:600;text-transform:uppercase;letter-spacing:.5px;margin-bottom:2px">Email</div><div style="font-family:'Bricolage Grotesque';font-weight:700;font-size:20px;color:#14202B">collen@gearhaven.com</div></div>
          </a>

          <a href="https://maps.app.goo.gl/JaRQ9VPfZmCQoCGt9" target="_blank" rel="noopener noreferrer" class="gh-contact-info-card" style="display:flex;align-items:center;gap:16px;background:#fff;border:1px solid #E7E3DB;border-radius:14px;padding:20px 22px;box-shadow:0 2px 4px rgba(20,32,45,.04);text-decoration:none">
            ...
            <div class="gh-contact-info-text"><div style="font-size:13px;color:#8A96A1;font-weight:600;text-transform:uppercase;letter-spacing:.5px;margin-bottom:2px">Visit the Shop</div><div style="font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;color:#14202B">1556 N Commercial Rd.<br>Nixa, MO 65714</div></div>
          </a>

          <div class="gh-contact-info-card" style="display:flex;align-items:center;gap:16px;background:#fff;border:1px solid #E7E3DB;border-radius:14px;padding:20px 22px;box-shadow:0 2px 4px rgba(20,32,45,.04)">
    ...
    <div class="gh-footer-grid" style="max-width:1240px;margin:0 auto;padding:60px 28px 32px;display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:40px">
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:14px;font-size:14.5px">
          ...
          <a href="mailto:collen@gearhaven.com" style="display:flex;align-items:flex-start;gap:12px;color:#8FA0AD;text-decoration:none" class="gh-hover-441">
