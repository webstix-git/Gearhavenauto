...
const posts: BlogPost[] = [
  {
    slug: "check-engine-light-common-causes", title:
      ...
      "A lit check engine light doesn't always mean disaster, but ignoring it can turn a small issue into an expensive repair. Here's what Missouri drivers should know.", category: "Diagnostics", author: "Gear Haven", publishedAt: "2026-07-07", readTime: "6 min read", image: "/images/asset-3-2597b98e.jpg", content: article(
    ...
    slug: "dealership-vs-independent-repair-shop", title:
      ...
      "Both options have strengths. Here's how to decide based on warranty, cost, expertise, and the kind of relationship you want with your shop.", category: "Maintenance", author: "Gear Haven", publishedAt: "2026-07-07", readTime: "6 min read", image: "/images/asset-5-2a89faa0.jpg", content: article(
